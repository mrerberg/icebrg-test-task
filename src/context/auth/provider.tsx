...
// - Бек бы сеттил секьюрные куки через заголовок
// - Фронт бы к своим запросам подкидывал эти куки
// - Если падает запрос на получение юзера (при первоначальной загрузке) или любой другой с ошибкой 401 - значит, нужно снова логиниться
